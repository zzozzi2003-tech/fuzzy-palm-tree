  ...
  try{
    ...
    session.onpaymentauthorized=async event=>{
      ...
      try{
        ...
        applePayStatus(`Payment confirmed. Order ${captured.orderNumber} is delivered.`,'');
    ...
    session.oncancel=()=>applePayStatus('Apple Pay was cancelled. No order was delivered.','info');
    session.begin();
