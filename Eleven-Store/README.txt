...
V6.6.0: PayPal Checkout added. See PAYPAL-SETUP.txt. Supabase persistence remains enabled through server.js when its environment variables are configured.
